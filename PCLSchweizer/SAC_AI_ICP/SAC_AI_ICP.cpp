...
//点云可视化
void visualize_ply(PointCloud::Ptr pcd_src,
   ...
   main (int argc, char** argv)
{
   ...
   pcl::io::loadPLYFile (argv[1],*cloud_src_o);  
   PointCloud::Ptr cloud_tgt_o (new PointCloud);//目标点云
   pcl::io::loadPLYFile (argv[2],*cloud_tgt_o);
   ...
   pcl::io::savePLYFileASCII("bunny_src_down.ply",*cloud_src);
   //计算表面法线
   ...
   pcl::io::savePLYFileASCII("bunny_tgt_down.ply",*cloud_tgt);
   ...
   pcl::io::savePLYFileASCII("bunny_transformed_sac.ply",*sac_result);
   ...
   //保存转换的输入点云
   pcl::io::savePLYFileASCII("bunny_transformed_sac_ndt.ply", *icp_result);
   ...
   //可视化
   visualize_ply(cloud_src_o,cloud_tgt_o,icp_result);
   return (0);
}
